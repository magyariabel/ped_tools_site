...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const pages = ["C:\\Users\\abel\\ped_tools_new\\ped_tools\\app\\page.tsx"];
...
const sections = [
    {
        title: "Stakeholders",
        icon: icons/* Icons */.P.users,
        href: "/stakeholders",
        description: "Explore the roles involved in PED design"
    },
    {
        title: "KPIs",
        icon: icons/* Icons */.P.barChart,
        href: "/kpis",
        description: "Key Performance Indicators for PED evaluation"
    },
    {
        title: "Tools",
        icon: icons/* Icons */.P.tools,
        href: "/tools",
        description: "Discover tools used in PED design and analysis"
    },
    {
        title: "Intervention Points",
        icon: icons/* Icons */.P.target,
        href: "/intervention-points",
        description: "Critical decision-making junctures in PED design"
    }
];
function Home() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                ...
                children: "Positive Energy District Design Tool"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                className: "text-xl",
                children: "Explore the components and relationships in PED design"
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6",
                children: sections.map((section)=>/*#__PURE__*/ jsx_runtime_.jsx((link_default()), {
                        href: section.href,
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(Card, {
                            className: "p-6 hover:shadow-lg transition-shadow",
                            children: [
                                /*#__PURE__*/ jsx_runtime_.jsx(section.icon, {
